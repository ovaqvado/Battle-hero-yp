const gameParameters = {
  ...
  function arena(firstHero, secondHero) {
    console.log(`Да пускай начнется битва! В левом ринге ${firstHero}  В правом ринге ${secondHero}`);
    ...
    console.log("Сумма всех параметров первого героя", firstHero);
    console.log("Сумма всех параметров второго героя", secondHero);
    ...
    if (winner) {
        console.log(`Вы выиграли суперприз: ${winner.name}`,"ваш приз 1миллион конфет");
        alert(`Вы выиграли суперприз: ${winner.name} ваш приз 1миллион конфет`);
    } else {
        console.log("Тренируйся чтоб победить в следующий раз");
        alert("Тренируйся чтоб победить в следующий раз");
    }
